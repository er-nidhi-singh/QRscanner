...
Route::get('/ac_list', function () { return view('pages.ac_list'); });
Route::get('/ac_form', function () { return view('pages.ac_form'); });
Route::get('/user_reg', function () { return view('pages.user_reg'); });